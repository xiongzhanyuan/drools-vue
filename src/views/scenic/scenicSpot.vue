    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" :before-close="handleClose">
      <el-form class="small-space" :model="temp" :rules="rules2" ref="temp" label-position="left" label-width="70px" style='width: 400px; margin-left:50px;'>
        ...
        <el-form-item label="图片">
          <UploadImageMulti childImageUrls=t emp.imageUrls v-model="temp.imageUrls" ref="imageMulti" @uploaded="imageUploaded" @removed="imageRemoved"></UploadImageMulti>
        </el-form-item>

        <el-form-item label="视频">
          <UploadVideo childVideoUrls=t emp.videoUrls v-model="temp.videoUrls" ref="uploadVideo" @videoUploaded="videoUploaded" @videoRemoved="videoRemoved"></UploadVideo>
        </el-form-item>

        <el-form-item label="语音">
          <UploadAudio childAudioUrls=t emp.audioUrls v-model="temp.audioUrls" ref="uploadAudio" @audioUploaded="audioUploaded" @audioRemoved="audioRemoved"></UploadAudio>
        </el-form-item>
